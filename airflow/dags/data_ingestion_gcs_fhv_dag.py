...
with DAG(
    ...
    format_fhv_csv_to_parquet_task = PythonOperator(
        task_id="format_fhv_csv_to_parquet_task",
    ...
    download_fhv_task >> format_fhv_csv_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task
